...
const WheresAndy = () => {
  return (
    <div
      className="WheresAndyWrapper relative z-[3] flex h-fit w-screen justify-center text-[12px]   
  text-sm xs:text-[1.5rem] sm:pt-4 sm:text-[1.8rem]   md:text-[2.2rem]  
         "
    >
      <div className="relative flex w-full justify-around text-amber-100   ">
        <a
          href="https://support.google.com/maps/answer/7326816?hl=en&co=GENIE.Platform%3DAndroid"
        ...
        <button
          onClick={() => (window.location.href = "tel:559-555-5555")}
